...
export type Settings = {
    pp_timer?: { baseURL: string, appKey: string, appSecret: string, accessTokenKey: string, accessTokenSecret: string },
...
export const App = () => {
    ...
    useAsyncEffect(async ({ aborted }) => { // init redmine and database with cookie key
        if (!settings?.pp_timer) return;
        const { pp_timer: { baseURL, appKey, appSecret, accessTokenKey, accessTokenSecret } } = settings;
